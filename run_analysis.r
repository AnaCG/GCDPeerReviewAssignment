##This is the script for the dataset that contains the averages of each variable for each activity and each subject
#Each section is commented, and the ones with numbers indicate which part of the instruction is being adressed
##set working directory in case is it not set
